...
public class ManageStore extends javax.swing.JPanel {
    ...
    public ManageStore(JPanel userProcessConatiner, PharmacyDirectory pharmacyDirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAddPharmacy.setText("Add Store");
    ...
    private void btnAddPharmacyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPharmacyActionPerformed
        AddStore aph = new AddStore(userProcessContainer,pharmacyDirectory);
